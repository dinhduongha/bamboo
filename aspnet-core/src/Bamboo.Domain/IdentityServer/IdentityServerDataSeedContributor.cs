...
namespace Bamboo.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        {
            await CreateApiScopeAsync("Bamboo");
        }
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("Bamboo", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            if (!webClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    secret: (configurationSection["Bamboo_Web:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            {
                var webClientRootUrl = configurationSection["Bamboo_App:RootUrl"]?.TrimEnd('/');

                await CreateClientAsync(
                    name: consoleAndAngularClientId,
                    scopes: commonScopes,
                    grantTypes: new[] { "password", "client_credentials", "authorization_code" },
                    secret: (configurationSection["Bamboo_App:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            if (!blazorClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    secret: configurationSection["Bamboo_Blazor:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
            ...
            if (!swaggerClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    scopes: commonScopes,
                    grantTypes: new[] { "authorization_code" },
                    secret: configurationSection["Bamboo_Swagger:ClientSecret"]?.Sha256(),
                    requireClientSecret: false,
