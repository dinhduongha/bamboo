            ...
            foreach (var entity in builder.Model.GetEntityTypes())
            {
                foreach (var property in entity.GetProperties())
                {
                    ...
                    if (fieldInfo != null)
                    {
                        ...
                        else if (fieldInfo.FieldType == typeof(System.String) && fieldInfo.Name == "extension_data")
                        {
                            property.SetColumnType("jsonb");
                        }
                        else if (fieldInfo.FieldType == typeof(System.String) && fieldInfo.Name == "extra_data")
                        {
                            property.SetColumnType("jsonb");
                        }
                    }
