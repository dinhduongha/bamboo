...
{
    public abstract class BambooWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BambooWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BambooWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BambooDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BambooDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BambooDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BambooDbContext, Task<T>> func)
        {
            T result;
